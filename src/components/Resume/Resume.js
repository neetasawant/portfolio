      ...
      <Container>
        ...
        <Row className="resume">
          ...
          <Col md={6} className="resume-left">
            ...
            <Resumecontent
              title="M.C.A (Goa University) "
              date="2016 - 2019"
              content={[]}
            />
            <Resumecontent
              title="Bsc. Computer Science [Dhempe College of Arts And Science]"
              date="2012 - 2015"
              content={[]}
            />
            <Resumecontent
              title="12TH BOARD [Dhempe College of Arts And Science] "
              date="2010 - 2012"
              content={[]}
            />
            <Resumecontent
              title="10TH BOARD [Mushtifund High School] "
              date="2000 - 2010"
              content={[]}
            />
          </Col>
