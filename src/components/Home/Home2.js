        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              I am from Goa, India. I hold a master's degree in Computer Application. Over the course of time, I have learnt a few programming languages. I love coding and designing.
              <br />
